...
// This module is included in the following assemblies:
// * tkn_cli/op-configuring-tkn.adoc
...
----
+
Or, you can save the file to a local directory and source it from your `.bashrc` file instead.
+
Opening a new terminal enables tab completion.
